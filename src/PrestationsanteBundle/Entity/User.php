...
class User
{
     ...
     * @var string
     *
     * @ORM\Column(name="adresse", type="string", length=32, nullable=false)
     */
    private $adresse;
     ...
     * @var string
     *
     * @ORM\Column(name="image", type="string", length=20000, nullable=false)
     */
    private $image;
     ...
     * @var string
     *
     * @ORM\Column(name="profession", type="string", length=32, nullable=false)
     */
    private $profession;
